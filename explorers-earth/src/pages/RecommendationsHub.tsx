...
const RecommendationsHub = () => {
  return (
    <div className="min-h-screen bg-dashboard-bg text-dashboard px-4 md:px-8 py-8 pb-24 max-w-5xl mx-auto">
      <div className="mb-8">
        <h1 className="text-3xl md:text-4xl font-black mb-2 tracking-tight text-white uppercase font-poppins">Recommendations</h1>
        <p className="text-sm md:text-base text-dashboard-muted leading-relaxed font-medium max-w-2xl">
          Manage and share your curated lists of locations, movies, books, games, apps, products, people, guides, and music.
        </p>
      </div>

...
describe("Music surface authorization policy", () => {
  ...
  it.each([
    ...
    ["/api/music/guest/request", "private", "guest"],
    ...
    ["/api/music/guest-capability/", "private", "owner"],
    ["/api/music/guest-capability/rotate", "private", "owner"],
    ["/api/music/publication/", "private", "owner"],
    ["/api/music/publication/publish", "private", "owner"],

...
describe("Music OpenAPI 3.1 executable contract", () => {
  ...
  it("validates mounted success DTOs for every product family against resolved 3.1 schemas", async () => {
    ...
    const cases = [
      ...
      ["patch", "/api/music/guest-controls", "/api/music/guest-controls", 200, { allowSongRequests: true, allowGuestPlayOnDevice: false, allowPlaylistSharing: true, allowRecentlyPlayedVisibility: true }, ownerWrite],

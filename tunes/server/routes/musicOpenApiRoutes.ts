...
const paths = {
  ...
  "/api/music/guest-controls": {
    ...
    patch: ownerOperation({ summary: "Update owner guest controls", status: "200", response: ref("GuestControls"), request: body(ref("GuestControls"), "Complete guest control state") }),
  },

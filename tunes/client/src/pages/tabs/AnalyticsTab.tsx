    ...
    <div className="space-y-6">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Average songs per host</p>
              </CardContent>
            </Card>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Track API usage and quota consumption</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{youtubeStats.total || 0}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{youtubeStats.daily?.[0]?.count || 0}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{youtubeStats.weeklyAvg || 0}</div>
                <p className="text-xs text-muted-foreground">Average requests per week</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{youtubeStats.monthlyTotal || 0}</div>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Unique guest visits</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Total song requests</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Average guest session</p>
              </CardContent>
            </Card>
          </div>
        </CardContent>
      ...
      <WorldMap regionalStats={analyticsData?.regionalStats || {}} isLoading={isLoading} />
    </div>
  );
}

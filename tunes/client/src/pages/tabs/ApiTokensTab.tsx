...
export default function ApiTokensTab() {
  ...
  const handleSubmit = (data: ApiTokenFormData) => {
    const payload: ApiTokenFormData = { ...data };
    ...
    <div className="space-y-6">
        ...
        <CardHeader>
          <div className="flex justify-between items-center">
            <div>
              ...
              <CardDescription>Manage API tokens for external application integrations</CardDescription>
            </div>
              ...
              <TableBody>
                {tokens.map((token) => (
                  <TableRow key={token.id}>
                    ...
                    <TableCell>
                      {token.isActive ? getExpirationStatus(token.expiresAt) : <Badge variant="secondary">Inactive</Badge>}
                    </TableCell>
                    <TableCell>
                      {token.userId ? (
      ...
      <Dialog open={isCreating} onOpenChange={setIsCreating}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Generate a new API token for external application access.</DialogDescription>
          </DialogHeader>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-4">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>A descriptive name for this token.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>What this token will be used for.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
              ...
              <div>
                ...
                <Select onValueChange={(value) => setSelectedUserId(value === "global" ? null : parseInt(value, 10))}>
                  <SelectTrigger>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>How to use the API tokens for integration</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div>

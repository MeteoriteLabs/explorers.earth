...
import { z } from "zod";
import { Users, UserPlus, Globe2, MoreVertical, Settings, Trash2 } from "lucide-react";
...
type EditableTeamMember = TeamMemberFormData & { id?: number };
                  ...
                  <Select
                    onValueChange={(value) => {
                      ...
                      if (currentRegions.includes(value)) {
                        field.onChange(currentRegions.filter((region) => region !== value));
                      } else {
    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage team members and their responsibilities</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="mb-6">
            <Button

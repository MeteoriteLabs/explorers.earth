...
const AdminSEOPage: React.FC = () => {
  ...
  // Check if user is a super admin (username-based check to match backend)
  ...
  // The isSuperAdmin check will be handled by AdminLayout now, 
  // so we can just pass it as a prop and remove this check
  
  if (isLoading) {
    return (
      <AdminLayout title="SEO Settings" isSuperAdmin={isSuperAdmin}>
        <div className="flex h-[calc(100vh-200px)] items-center justify-center">
          <Loader2 className="h-12 w-12 animate-spin text-primary" />
          <p className="ml-2 text-xl">Loading SEO settings...</p>
        </div>
      </AdminLayout>
    );
  }
      ...
      <div className="container mx-auto py-8">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground mt-2">
            Manage your website's SEO settings to improve search engine visibility and social media sharing appearance.
          </p>
        </div>

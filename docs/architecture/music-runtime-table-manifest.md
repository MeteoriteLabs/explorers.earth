...
checksummed `0001_runtime_baseline`, `0002_identity_lifecycle`, and
`0003_identity_lifecycle_hardening` migration
...
either document ID and retain a tombstone after deletion. No retention duration

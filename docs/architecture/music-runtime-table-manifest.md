...
`0005_resource_bound_deletion_history` migration
...
to the removed user row, and deletion replay requires the exact numeric ID and
operation ID pair. No retention duration

...
`0012_publication_replay_expiry_guard` migration (following the immutable `0011_durable_publication_idempotency` authority)
...
stores raw idempotency keys or plaintext guest capabilities. Catalog fingerprints include

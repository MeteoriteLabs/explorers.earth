...
`0009_credential_revocation_history_immutability` migration
...
idempotency history, and `music_credential_revocation_operations` durable
credential-revocation history are control tables outside the runtime-reference count. Catalog

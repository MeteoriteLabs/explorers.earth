...
*   [public_profile.html](file:///d:/Project/explorers.earth/docs/design-system/mockups/page/public_profile.html) ([Design Spec](file:///d:/Project/explorers.earth/docs/design-system/mockups/page/public_profile.md)) - **Public Profile**: High-fidelity reproduction of the public profile page. Features fixed header, cover banner with blur mask, location details, social media row, and interactive tabs (Recommendations category cards, Gallery grid, and Business details).
...
*   [public_movie_game_book.html](file:///d:/Project/explorers.earth/docs/design-system/mockups/page/public_movie_game_book.html) ([Design Spec](file:///d:/Project/explorers.earth/docs/design-system/mockups/page/public_movie_game_book.md)) - **Public Media Pages**: Public recommendations layouts for movies, games, and books. Features fixed header, responsive Top Picks hero section (desktop slideshow vs mobile stacked cards), list scroll carousels, category browse, and interactive detail modal.
...
*   [public_places.html](file:///d:/Project/explorers.earth/docs/design-system/mockups/page/public_places.html) ([Design Spec](file:///d:/Project/explorers.earth/docs/design-system/mockups/page/public_places.md)) - **Public Places Page**: Public recommendations dashboard for geographic places. Features desktop featured slideshow, mobile overlapping stacked picks, horizontal scrollable list carousels, grid curation details view, and place details modal.
*   [public_guides.html](file:///d:/Project/explorers.earth/docs/design-system/mockups/page/public_guides.html) ([Design Spec](file:///d:/Project/explorers.earth/docs/design-system/mockups/page/public_guides.md)) - **Public Travel Guides**: Travel guides layout with featured guide hero banner, responsive inline filters (desktop) / slide-out filter drawer (mobile), and interactive details modal.
*   [public_music.html](file:///d:/Project/explorers.earth/docs/design-system/mockups/page/public_music.html) ([Design Spec](file:///d:/Project/explorers.earth/docs/design-system/mockups/page/public_music.md)) - **Public Music Page**: Public music recommendation and song request queue page. Features responsive Top Picks hero section (desktop full-width banner with overlay queue thumbs vs mobile stacked cards with dot navigation and auto-advance), search song request panel, collapsible accordion sections (Queue, Recently Played, Playlists, Play on Your Device), and active playlist tabs switching.
